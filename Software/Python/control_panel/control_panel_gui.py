...
class gopigo_control_app(wx.Frame):
	...
	def initialize(self):
		...
		self.trim_label = wx.StaticText(self, -1,
										label="You can adjust the trim of your GoPiGo to help it go straight forward.\nUse the slider below to adjust the trim difference between the left\nand right motors.",
										pos=(x, y + 6 + dist / 2 + 40))
		sizer.Add(self.firmware_label, (1, 0), (1, 2), wx.EXPAND)
		...
		self.slider = wx.Slider(self, value=0, minValue=-100, maxValue=100, pos=(x + dist * 2, y + dist / 2),
